...
- **A formula, if the structure has one** (e.g. passive voice: *be* + past participle; present perfect: *have/has* + past participle; second conditional: *If* + past simple, *would* + base verb). Skip this only for grammar points that aren't formulaic (e.g. article usage, word order preferences).
